...
<div class="container">
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                <a href="https://github.com/toys0ldier/malware_keywords">https://github.com/toys0ldier/malware_keywords</a>
            </td>
        </tr>
    </table>
    ...
    <table class="table">
        ...
        <tr>
            ...
            <td>
                ...
                <ul>
                    <li>
                        <span class="hash_font"><?php echo h('doc.missing'); ?></span> <?php echo h('doc.status_missing'); ?>
                    </li>
                    <li>
                        <span class="hash_font"><?php echo h('doc.pending'); ?></span> <?php echo h('doc.status_pending'); ?>
                    </li>
                    <li>
                        <span class="hash_font"><?php echo h('doc.processing'); ?></span> <?php echo h('doc.status_processing'); ?>
                    </li>
                    <li>
                        <span class="hash_font"><?php echo h('doc.finished'); ?></span> <?php echo h('doc.status_finished'); ?>
                    </li>
                </ul>
            </td>
            <td>JSON</td>
