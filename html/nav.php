...
<div class="navbar navbar-inverse navbar-fixed-top">
	<div class="navbar-inner">
		<div class="container-fluid">
			<a class="brand" href="<?php echo htmlspecialchars(i18n_url_with_lang('index.php', $current_locale), ENT_QUOTES, 'UTF-8'); ?>" name="top">&nbsp;&nbsp;&nbsp;&nbsp;<b>Mal</b>Share</a>
			<div class="nav-collapse collapse">
				<ul class="nav">

<li <?php if (stripos($_SERVER['REQUEST_URI'],'index.php') !== false) {echo 'class="active"';} ?>>
	<a href="<?php echo htmlspecialchars(i18n_url_with_lang('index.php', $current_locale), ENT_QUOTES, 'UTF-8'); ?>"><?php echo h('nav.home'); ?></a></li>
<li <?php if (stripos($_SERVER['REQUEST_URI'],'upload.php') !== false) {echo 'class="active"';} ?>>
	<a href="<?php echo htmlspecialchars(i18n_url_with_lang('upload.php', $current_locale), ENT_QUOTES, 'UTF-8'); ?>"><?php echo h('nav.upload'); ?></a></li>
<li <?php if (stripos($_SERVER['REQUEST_URI'],'search.php') !== false) {echo 'class="active"';} ?>>
	<a href="<?php echo htmlspecialchars(i18n_url_with_lang('search.php', $current_locale), ENT_QUOTES, 'UTF-8'); ?>"><?php echo h('nav.search'); ?></a></li>
<li <?php if (stripos($_SERVER['REQUEST_URI'],'pull.php') !== false) {echo 'class="active"';} ?>>
	<a href="<?php echo htmlspecialchars(i18n_url_with_lang('pull.php', $current_locale), ENT_QUOTES, 'UTF-8'); ?>"><?php echo h('nav.download'); ?></a></li>
...
<li <?php if (stripos($_SERVER['REQUEST_URI'],'doc.php') !== false) {echo 'class="active"';} ?>>
	<a href="<?php echo htmlspecialchars(i18n_url_with_lang('doc.php', $current_locale), ENT_QUOTES, 'UTF-8'); ?>"><?php echo h('nav.api'); ?></a></li>
<li <?php if (stripos($_SERVER['REQUEST_URI'],'about.php') !== false) {echo 'class="active"';} ?>>
	<a href="<?php echo htmlspecialchars(i18n_url_with_lang('about.php', $current_locale), ENT_QUOTES, 'UTF-8'); ?>"><?php echo h('nav.about'); ?></a></li>
...
?>
								<ul class="nav pull-right">
									<li class="navbar-form" style="margin: 0 10px 0 0;">
										<select class="input-mini" style="width: 58px;" onchange="var opt=this.options[this.selectedIndex]; if (opt && opt.value) { document.cookie = 'mlang=' + opt.getAttribute('data-locale') + '; path=/; max-age=15552000'; window.location = opt.value; }">
