    ...
    <div class="jumbotron">
        ...
        <div class="container" <?php if ($showDivFlag === false){ ?>style="display:none"<?php } ?>>
            ...
            <form method="get" action="search.php" class="form-signin" id="search_form" onsubmit="ShowLoading()">
                ...
                <div>
                    <input type="text" class="input-block-level" name="query"
                           placeholder="<?php echo h('search.placeholder'); ?>" value="<?php echo $display_query; ?>">
                    <label class="checkbox"><input type="checkbox"
                                                   name="private" <?php echo $private_checked; ?> > <?php echo h('search.private'); ?>
                    </label>
                ...
                <table class="table table-bordered table-striped">
                    <thead>
                    <tr>
                        <th><h4><?php echo h('search.recent'); ?></h4></th>
                    </tr>
                    </thead>
                    <tbody>
