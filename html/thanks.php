...
<div class="container">
    <div class="hero-unit">
        ...
        <table class="table">
            <thead>
            <tr>
                <th scope="col"><?php echo h('thanks.year'); ?></th>
                <th scope="col"><?php echo h('thanks.name'); ?></th>
                <th scope="col"><?php echo h('thanks.bug'); ?></th>
            </tr>
            </thead>
            <tbody>
            <tr>
                <td>2019</td>
                <td>Aqib Shah</td>
                <td>Registration XSS and ClickJacking</td>
            </tr>
            </tbody>
        </table>
